...
const mockData = [    new TitleBlock('Website Builder In Javascript!', {
    tag: 'h2',
    styles: toCss({
    ...
    new TextColumnsBlock(
        'A closure is the combination of a function and the lexical environment within which that function was declared. :: An overview for those who think they know about JavaScript. :: Strict mode defines that you can not use any variable before initializing it. It is a restricted variant of ECMAScript 5, for faster performance and easier debugging.'
        , {
            styles: toCss({
                padding: '2rem 0',
                color: "#fff",
